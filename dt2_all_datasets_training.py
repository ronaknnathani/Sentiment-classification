...
if __name__ == '__main__':
    ...
    try:
        ...
        #fname_trn4 = os.path.join(args.d, "dt1_vld_lsa.svm") 
        ...
        fname_vld_lbl = os.path.join(args.d, "dt%d.%s.lsa.lbl" % (args.id, "vld"))
        fname_tst_lbl = os.path.join(args.d, "dt%d.%s.lsa.lbl" % (args.id, "tst"))

        fname_vld_pred = os.path.join(args.d, "dt%d.%s.lsa.pred" % (args.id, "vld"))
        fname_tst_pred = os.path.join(args.d, "dt%d.%s.lsa.pred" % (args.id, "tst"))
        ...
        dt2_grid = [{'kernel': ['rbf'], 'C': [1.0, 100.0, 850.0],
                     'gamma': [0.1, 1.0, 47.0]}]
