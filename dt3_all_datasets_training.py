...
if __name__ == '__main__':
    ...
    try:
        ...
        fname_trn1 = os.path.join(args.d, "dt1_trans_pca.svm") 
        fname_trn2 = os.path.join(args.d, "dt2_trans_pca.svm") 
        fname_trn3 = os.path.join(args.d, "dt3_trans_pca.svm")
        #fname_trn4 = os.path.join(args.d, "dt1_vld_pca.svm")
        #fname_trn5 = os.path.join(args.d, "dt2_vld_pca.svm") 
        ...
        #data_trn4, lbl_trn4 = load_svmlight_file(fname_trn4, n_features=100, zero_based=True)
        #data_trn5, lbl_trn5 = load_svmlight_file(fname_trn5, n_features=100, zero_based=True)

        print data_trn1.shape
        print data_trn2.shape
        print data_trn3.shape
        #print data_trn4.shape
        #print data_trn5.shape
        ...
        dt3_grid = [{'kernel': ['rbf'], 'C': [0.1, 1.0, 100.0],
                     'gamma': [0.1, 1.0, 10.0]}]
